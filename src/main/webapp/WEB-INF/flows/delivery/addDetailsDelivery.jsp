                ...
                <form:form modelAttribute="deliveryOrder.delivery" class="form-horizontal">
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                                                <form:select id="place" path="place.placeNo" class="form-control" disabled="${deliveryOrder.delivery.status=='FI'?'true':'false'}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                                                <form:textarea id="description" type="text" rows="3" path="description" class="form-control" placeholder="Dodatkowe informacje" 
                                                                                                                 readonly="${deliveryOrder.delivery.status=='FI'?'true':'false'}"/>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <button type="submit" name="_eventId_saveChange" class="btn btn-primary" ${deliveryOrder.delivery.status=='FI'?'disabled':''}>
                                Zapisz <span class="glyphicon glyphicon-ok"></span>
                            </button>

                            <button type="submit" name="_eventId_addItems" class="btn btn-primary" ${deliveryOrder.delivery.status=='FI'?'disabled':''}>
                                Dodaj <span class="glyphicon glyphicon-plus"></span>
                            </button>     
                                    
                            <button type="submit" name="_eventId_delete" class="btn btn-danger" 
                                               ${deliveryOrder.delivery.status=='FI'||fn:length(deliveryOrder.delivery.deliveryItemSet)>0?'disabled':''}>
