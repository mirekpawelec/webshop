...
<spring:message code="showQuestionFaq.answer.label" var="answerLbl" />
<spring:message code="showQuestionFaq.status.label" var="statusLbl" />
<spring:message code="showQuestionFaq.lastModificationDate.label" var="lastModificationDateLbl" />
<spring:message code="showQuestionFaq.createDate.label" var="createDateLbl" />

<div class="row">
    <div class="form-group">
        <div class="col-xs-12">
            <label class="control-label"><strong> ${answerLbl} </strong></label>
        </div>
        <div class="col-xs-12">
            <textarea type="text" class="form-control" rows="12" readonly="true"> ${param.answer} </textarea>
        </div>
    </div>
</div>
