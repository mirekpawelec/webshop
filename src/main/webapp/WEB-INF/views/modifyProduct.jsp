        ...
        <section class="container">
            <div class="row text-center">
                <div class="page-header">
                    <h2>Edycja produktu ${productNumber}</h2>
                </div>
            </div>
            
            <form:form modelAttribute="modifyProduct" class="form-horizontal">
                <fildset>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9 col-md-8 col-lg-7">
                                <input type="submit" value="Zatwierdź" class="btn btn-primary btn-lg pull-right"/>
                            </div>
                        </div>
                    </div>
                </fildset>
