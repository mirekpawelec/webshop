...
@Component
@Aspect
public class SystemClassControllerAop {
    private static final Logger log = Logger.getLogger(SystemClassControllerAop.class);
    
    @Around("execution(* pl.pawelec.webshop.controller.SystemClassController.*(..))")
