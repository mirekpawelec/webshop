...
@Component
@Aspect
public class DeliveryControllerAop {
    private static final Logger log = Logger.getLogger(DeliveryControllerAop.class);
    
    @Around("execution(* pl.pawelec.webshop.controller.DeliveryController.*(..))")
