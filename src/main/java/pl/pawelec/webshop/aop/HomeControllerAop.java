...
@Component
@Aspect
public class HomeControllerAop {
    private static final Logger log = Logger.getLogger(HomeControllerAop.class);
    
    @Around("execution(* pl.pawelec.webshop.controller.HomeController.*(..))")
