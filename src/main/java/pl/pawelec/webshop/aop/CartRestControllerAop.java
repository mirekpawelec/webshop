...
@Component
@Aspect
public class CartRestControllerAop {
    private static final Logger log = Logger.getLogger(CartRestControllerAop.class);
    
    @Around("execution(* pl.pawelec.webshop.controller.CartRestController.*(..))")
